...
class Ui_MainWindow(QtWidgets.QWidget):
    def setupUi(self, MainWindow):
        ...
        self.smallframe.setStyleSheet("background-color : #1B1B1B")
        ...
        self.securecon.setStyleSheet("color: white")
    ...
    def show_popup2(self):
        src = QtWidgets.QInputDialog.getText(self, 'Scanning', 'Enter your path to perform backup: ')
        dest = QtWidgets.QInputDialog.getText(self, 'Scanning', 'Enter your destination (will create dir.): ')
        print(src[0], dest[0])
        if (src[0] or dest[0]) == '':
            return 0;
        else:
